    ...
    <nav class="navbar bg-light ">
      ...
      <div class=" col-2"> Ordered By : <br> <br>
        <div class="btn-group mb-3 " role="group" aria-label="Basic mixed styles example">
          {!! Form::open(['route' => ['m-book.latest'] , "class" => "btn p-0 ml-2 btn-danger" , "method" =>
          "get"]) !!}
...
<div class="row m-0">
  <form method="get">
    <div class="col-lg-3 col-md-6 pt-5" id="filter">
    {!! Form::open(['route' => ['filter'] , "class" => "btn p-0 ml-2 btn-danger" , "method" =>"get"]) !!}          
      <ul class="list-group list-group">
                        <li class="list-group-item d-flex justify-content-between align-items-start">
                          <div class="ms-2 me-auto">
                            <div class="fw-bold"><a href="#"></a></div>
                          </div>
...
<div class="col-2 pt-5">
  <div class="card h-100">
    ...
    <div class="d-flex gap-2 mx-auto ">
      ...
      {!! Form::open(['route' => ['m-book.edit' , $book->id ] , "class" => "btn p-0 btn-primary" , "method" =>
      "get"]) !!}
      <td><button class="btn p-1 btn-primary">Update</button></td>
      {!! Form::close() !!}

      {!! Form::open(['route' => ['m-book.destroy' , $book->id ] , "class" => "btn p-0 btn-danger" , "method" =>
      "delete"]) !!}
